...
function setup() {
  ...
  circle1 = new Circle(200, 200, 100, -PI*0.834); // The first circle's radius is set to 150 degrees (PI/2 radians)
  circle2 = new Circle(500, 200, 100,0, TWO_PI); // The second circle's radius starts at 0 degrees (HALF_PI radians)
