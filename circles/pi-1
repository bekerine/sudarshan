...
function setup() {
  ...
  circle1 = new Circle(100, 150, 50, PI*0.835); // The first circle's radius is set to 150 degrees (PI/2 radians)
  circle2 = new Circle(300, 150, 50, 0, HALF_PI); // The second circle's radius starts at 0 degrees (HALF_PI radians)
